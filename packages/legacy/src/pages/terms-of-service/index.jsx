...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <Section
      title="Heather Turano Coaching, LLC Terms of Service"
      styleType="alt"
    >
      <Markdown>
        <div>
          ...
          <ol type="a">
            <li>
              ...
              <ol type="i">
                ...
                <li>
                  ...
                  contained on Heather Turano Coaching, LLC&apos;s website;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Heather Turano
              Coaching, LLC at any time. Upon terminating your viewing of these
          ...
          <ol type="a">
            <li>
              ...
              provided on an &apos;as is&apos; basis. Heather Turano Coaching,
          ...
          <p>
            ...
            Coaching, LLC&apos;s website, even if Heather Turano Coaching, LLC
            or a Heather Turano Coaching, LLC authorized representative has been
          ...
          <p>
            The materials appearing on Heather Turano Coaching, LLC&apos;s
            website could include technical, typographical, or photographic
            errors. Heather Turano Coaching, LLC does not warrant that any of
            the materials on its website are accurate, complete or current.
            Heather Turano Coaching, LLC may make changes to the materials
            contained on its website at any time without notice. However Heather
            Turano Coaching, LLC does not make any commitment to update the
            materials.
          </p>
          <h1>6. Links</h1>
          <p>
            Heather Turano Coaching, LLC has not reviewed all of the sites
            ...
            endorsement by Heather Turano Coaching, LLC of the site. Use of any
            such linked website is at the user&apos;s own risk.
          </p>
          <h1>7. Modifications</h1>
          <p>
            Heather Turano Coaching, LLC may revise these terms of service for
          ...
          <p>
            ...
            accordance with the laws of Delaware and you irrevocably submit to
